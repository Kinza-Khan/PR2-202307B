        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="allUsers.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Users</a>
                    <a href="order.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Orders</a>
                    <a href="feedback.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Feedback</a>
